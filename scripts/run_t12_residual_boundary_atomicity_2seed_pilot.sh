...
ROOT="$W/artifacts/t12/residual_boundary_atomicity_2seed_pilot"
...
for seed in 101 102; do
  id="t12_residual_boundary_atomicity_seed${seed}"
  out="$ROOT/runs/$id"
...
from pathlib import Path
root=Path('/home/robot/robot_ws_base_rl/artifacts/t12/residual_boundary_atomicity_2seed_pilot')
...
runs={}
for seed in (101,102):
 run=root/'runs'/f't12_residual_boundary_atomicity_seed{seed}'
 log_path=root/'logs'/f't12_residual_boundary_atomicity_seed{seed}.log'
...
report={'schema_version':'1.0','task':'T12','study':'residual_episode_boundary_atomicity_two_seed_pilot',
...
output=root/'t12_residual_boundary_atomicity_2seed_report.yaml'
