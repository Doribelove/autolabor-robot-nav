...
ROOT="$W/artifacts/t12/residual_activation_timeout_barrier_stress"
CONFIG="$W/config/thesis_experiments/t12_residual_boundary_atomicity.yaml"
ID=t12_residual_activation_barrier_seed101
OUT="$ROOT/runs/$ID"
...
root=Path('/home/robot/robot_ws_base_rl/artifacts/t12/residual_activation_timeout_barrier_stress')
run=root/'runs'/'t12_residual_activation_barrier_seed101'
log_path=root/'logs'/'t12_residual_activation_barrier_seed101.log'
...
report={'schema_version':'1.0','task':'T12','study':'residual_activation_timeout_recovery_barrier_stress',
...
out=root/'t12_residual_activation_timeout_barrier_stress_report.yaml'; out.write_text(yaml.safe_dump(report,sort_keys=False))
