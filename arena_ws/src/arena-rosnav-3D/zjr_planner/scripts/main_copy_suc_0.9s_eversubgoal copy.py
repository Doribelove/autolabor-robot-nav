...
def pipeline_generate_subgoal_from_pose(start_x, start_y, goal_x, goal_y):
    ...
    out_paths = os.path.expanduser("~/catkin_arena/src/zjr_planner/scripts/data_json/paths.json")
    try:
    ...
    merged_out = os.path.expanduser("~/catkin_arena/src/zjr_planner/scripts/data_json/example_data.json")
    try:
