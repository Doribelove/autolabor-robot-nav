"""Fail-closed execution-release validation for R6-I3.

This module is deliberately ROS-free and process-free.  It only reads files,
hashes and parses immutable snapshots, and validates a future execution
release.  It does not create the canonical release, an execution directory, a
journal, a log, or a subprocess.
...
def load_and_validate_execution_release(
    ...
    *,
    ...
    authorization_bindings = authorization_snapshot.document.get("bound_resources")
    _require(isinstance(authorization_bindings, Mapping), "authorization resources missing")
    authorization_resources = {}
    for label, row in authorization_bindings.items():
