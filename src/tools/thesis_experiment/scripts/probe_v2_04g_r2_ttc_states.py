#!/usr/bin/env python3
"""Produce the frozen three-state TTC component probe for V2-04G-R2."""
...
def main():
    ...
    if prereg.get("stage") != "V2-04G-R2" or prereg.get("split") != "calibration":
        raise ValueError("TTC probe requires R2 calibration preregistration")
