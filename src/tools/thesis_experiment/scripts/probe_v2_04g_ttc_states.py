#!/usr/bin/env python3
"""Produce the three preregistered TTC semantic component probes."""
...
def main():
    ...
    if prereg["stage"] != "V2-04G" or prereg["split"] != "calibration":
        raise ValueError("TTC probe requires V2-04G calibration preregistration")
