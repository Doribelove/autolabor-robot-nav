#!/usr/bin/env python3
"""Produce the frozen three-state TTC component probe for V2-04G-R1."""
...
def main():
    ...
    if prereg["stage"] != "V2-04G-R1" or prereg["split"] != "calibration":
        raise ValueError("TTC probe requires V2-04G-R1 calibration preregistration")
    ...
    probes = [
        {
            "probe_id": "healthy_observed_conflict",
            "tracker_message_count": 1, "healthy_tracker_sample_count": 1,
            "finite_ttc_sample_count": int(conflict is not None),
            "finite_ttc_s": conflict,
        },
        {
            "probe_id": "healthy_no_conflict_in_horizon",
            "tracker_message_count": 1, "healthy_tracker_sample_count": 1,
            "finite_ttc_sample_count": int(clear is not None),
            "finite_ttc_s": clear,
        },
        {
            "probe_id": "tracker_invalid_fail_closed",
            "tracker_message_count": 0, "healthy_tracker_sample_count": 0,
            "finite_ttc_sample_count": 0, "finite_ttc_s": None,
        },
    ]
    for probe in probes:
    ...
    report = {
        ...
        "status": "complete" if statuses == expected else "failed",
        ...
        "observed_status_order": statuses, "all_three_states_pass": statuses == expected,
        "probes": probes,
    }
